function Instructions() {
  return(
    <> 
      ...
      <br />
      <h5>Results</h5>
      <p>When finished, we will have the files necessary for completing the remaining steps. </p>
      <br />


      <h3>Step 2: Installing REFramework Mods</h3>
      <p>Installing REFramework Mods is the process of installing mods for Monster Hunter Rise that specifically require REFramework to function. For this step we will be incorporating REFramework into Monster Hunter Rise and installing a mod that had REFramework as a dependency. </p>
      <br />
      <h5>Requirements</h5>
      <p>Monster Hunter Rise needs to be installed on your computer.</p>
      <h5>Steps</h5>
      <ol type="1">
        <li>Open the Monster Hunter Rise directory containing the game files. To find it, open Steam and navigate to your games library. Right-click on MONSTER HUNTER RISE, select Manage, and click Browse local files (Figure 2); This will open the folder.</li>
        <li>Copy the file Dinput8.dll from the REFramework mod folder and paste it into the MonsterHunterRise folder opened on step 1. Then, start Monster Hunter Rise. If done correctly, REFramework will be installed, and a small, black window will appear over the splash screen on the top-left corner (Figure 3). Close the game.</li>
        <li>Copy the file VIP_Dango_Ticket.lua from the VIP Dango Ticket mod folder.</li>
        <li>Navigate into the reframework folder inside the MonsterHunterRise folder, then into the autorun folder. Paste the file copied from part 3 into this folder.</li>
      </ol>
      <br />
      <h5>Results</h5>
      <p>When finished, any skill will activate with a rate of 100% when using a dango ticket (Figure 4</p>
      <br />


      <h3>Step 3: Installing Mods with Fluffy Manager 5000</h3>
      <p>Installing Mods with Fluffy Manager 5000 is the process of installing mods for Monster Hunter Rise that are compatible with Fluffy Manager 5000. Fluffy Manager 5000 is used to easily install and uninstall certain kinds of mods.</p>
      <br />
      <ol type="1">
        <li>Run Modmanager.exe inside the Fluffy Manager folder. In the manager window, a list of games should be displayed; Select Monster Hunter Rise from the list of games (Figure 5). This will create a new folder called games inside of the Fluffy Manager folder. Close the manager.</li>
        <li>Open the folder for the alchemy enhancement mod, called All Skill Fluffy Manager…. Inside, there will be a folder called Alchemy Enhancement. Copy the folder.</li>
        <li>Navigate into the games folder in the Fluffy Manager folder, then the MHRISE folder, then the Mods folder. Paste the alchemy mod folder inside here.</li>
        <li>Open the Fluffy Manager. A new list item will be displayed, called Alchemy Enhancement for Sunbreak TU3 with a toggle button on the left side (Figure 6). Click the toggle to activate the mod.</li>
      </ol>
      <br />
      <p>When finished, in-game talismans obtained from the highest 3 melding tiers will almost always have the maximum amount of skill points and slots.</p>
      <br />

      <h3>Step 4: Installing PAK Mods</h3>
      <p>Installing PAK Mods is the process of installing mods for Monster hunter Rise that come in the format of PAK files. This process requires that the mod files follow a specific naming convention to work. If you are installing PAK mods, keep track of which files are native game files and which ones are mod files.</p>
      <br />
      <h5>Steps</h5>
      <ol type="1">
      ...
      <br />
      <h5>Results</h5>
      <p>When finished, you will be able to craft decorations in-game without spending materials.</p>
      <br />

      <h4>Conclusion</h4>
      <p>Installing mods for Monster Hunter rise is the process of incorporating community-created code into your locally installed game files to affect how the game runs. With the correct tools, the game can be altered in a variety of ways, and players can enhance their game experience however they wish.</p>
    </>
  );
}
